...
//                            System.out.println(newValidPlus.area);
        ...
        for (int i = 0; i < validPluses.size(); i++) {
            ...
            System.out.println("currentValidPlus area: "+ currentValidPlus.area);
            for (int j = i + 1; j < validPluses.size(); j++) {
                ...
                if (currentArea > maxArea) {
                	System.out.println("currentArea "+currentArea+ "maxArea "+maxArea);
